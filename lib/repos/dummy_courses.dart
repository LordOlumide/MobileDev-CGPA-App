...
List<CourseResult> firstYear1 = [
  ...
  CourseResult(courseTitle: 'MTS 101', courseDescription: 'Basic Maths', marks: 65, units: 2),
  CourseResult(courseTitle: 'BCH 101', courseDescription: 'Intro to BioChemistry', marks: 72, units: 1),
  CourseResult(courseTitle: 'EEE 103', courseDescription: 'Electronics and Electric Laws', marks: 81, units: 1),
  CourseResult(courseTitle: 'PHY 103', courseDescription: 'Physics Practicals', marks: 55, units: 2),
  CourseResult(courseTitle: 'MEE 101', courseDescription: 'Engineering Drawing', marks: 65, units: 3),
];
...
List<CourseResult> firstYear2 = [
  ...
  CourseResult(courseTitle: 'MTS 102', courseDescription: 'Basic Maths', marks: 80, units: 2),
  CourseResult(courseTitle: 'BCH 102', courseDescription: 'Intro to BioChemistry', marks: 69, units: 3),
  CourseResult(courseTitle: 'EEE 104', courseDescription: 'Electronics and Electric Laws', marks: 81, units: 1),
  CourseResult(courseTitle: 'PHY 102', courseDescription: 'Physics Practicals', marks: 55, units: 3),
  CourseResult(courseTitle: 'MEE 102', courseDescription: 'Engineering Drawing', marks: 70, units: 3),
];
...
List<CourseResult> secondYear1 = [
  ...
  CourseResult(courseTitle: 'MTS 201', courseDescription: 'Basic Maths', marks: 65, units: 2),
  CourseResult(courseTitle: 'BCH 201', courseDescription: 'Intro to BioChemistry', marks: 72, units: 1),
  CourseResult(courseTitle: 'EEE 203', courseDescription: 'Electronics and Electric Laws', marks: 81, units: 1),
  CourseResult(courseTitle: 'PHY 203', courseDescription: 'Physics Practicals', marks: 55, units: 2),
  CourseResult(courseTitle: 'MEE 201', courseDescription: 'Engineering Drawing', marks: 65, units: 3),
];
...
List<CourseResult> secondYear2 = [
  ...
  CourseResult(courseTitle: 'MTS 202', courseDescription: 'Basic Maths', marks: 80, units: 2),
  CourseResult(courseTitle: 'BCH 202', courseDescription: 'Intro to BioChemistry', marks: 69, units: 3),
  CourseResult(courseTitle: 'EEE 204', courseDescription: 'Electronics and Electric Laws', marks: 81, units: 1),
  CourseResult(courseTitle: 'PHY 102', courseDescription: 'Physics Practicals', marks: 60, units: 3),
  CourseResult(courseTitle: 'MEE 102', courseDescription: 'Engineering Drawing', marks: 70, units: 3),
];